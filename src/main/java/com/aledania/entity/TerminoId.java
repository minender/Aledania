...
public class TerminoId  implements java.io.Serializable {
    ...
    @Length(min=1,message="You can not leave the Alias ​​field empty")
    @Pattern(regexp="^[A-Z][a-z]+$",message="The alias must start in upper case and the other characters in lowercase")
