...
<html>
    ...
    <center>
        <sf:form method="POST" modelAttribute="registro">
            <table>
                <tr><td>Nombre:</td><td><sf:input path="nombre" id="registro_nombre"/><br/><sf:errors path="nombre" cssClass="error" /></td></tr>
                ...
                <c:choose>
                 <c:when test="${isRegistro=='1'}">
                  <tr><td>Login:</td><td><sf:input path="login" id="registro_login"/><sf:errors path="login" cssClass="error" /></td></tr>
                 </c:when>
                 <c:otherwise>
                  <sf:input path="login" id="registro_login" type="hidden"/>   
                 </c:otherwise>
                </c:choose>
                <tr><td>Password:</td><td><sf:password path="password" showPassword="true" id="registro_password"/><sf:errors path="password" cssClass="error" /></td></tr>
                <tr><td>Confirme su password:</td><td><sf:password path="passwordConf" showPassword="true" id="registro_passwordConf"/><sf:errors path="passwordConf" cssClass="error" /></td></tr>
            </table>
